...
export default function IntroSliderScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Connect. Grow. Play.</Text>
      <Text style={styles.subtitle}>Discover players, coaches and clubs. Showcase achievements. Build your sports network.</Text>
